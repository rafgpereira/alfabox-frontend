...
import {
  ReportsService,
  MaintenanceExecutionReportItem,
  MaintenanceExecutionsReportResponse,
...
import { MaintenanceType } from '../../../shared/models/maintenance.model';

@Component({
  selector: 'app-maintenances-assemblers',
  imports: [...SHARED_CRUD_IMPORTS, CurrencyPipe, DatePipe],
  templateUrl: './maintenances-assemblers.html',
  styleUrl: './maintenances-assemblers.scss',
})
export class MaintenancesAssemblers implements OnInit {
  ...
  report: MaintenanceExecutionsReportResponse | null = null;
